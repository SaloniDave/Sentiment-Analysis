...
file="C:/Users/Saloni Dave/Downloads/twitterOauth.txt"
...
searchTerms = c("IPL + India")

set.seed(1234)
pos = scan('C:/Users/Saloni Dave/Downloads/positive-words.txt',
           what='character',
           comment.char=';')
...
neg = scan('C:/Users/Saloni Dave/Downloads/negative-words.txt',
           what='character',
           comment.char=';')
...
inspect(tweets_corpus_clean[1:5])
